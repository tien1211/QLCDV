    ...
    public function run()
    {
        $arr=[
            [
                ...
                'ttndk_ten' => 'Lê Thị A',
                'ttndk_gt' => 0,
                'ttndk_cmnd' => '0365478512',
                'ttndk_trangthai' => 1
            ],[
                'dkt_id' => 1,
                'ttndk_ten' => 'Trần Văn B',
                'ttndk_gt' => 1,
                'ttndk_cmnd' => '0321458962',
                'ttndk_trangthai' => 1
            ],[
                'dkt_id' => 2,
                'ttndk_ten' => 'Lê Văn A',
                'ttndk_gt' => 1,
                'ttndk_cmnd' => '0359631547',
                'ttndk_trangthai' => 1
            ],[
                'dkt_id' => 2,
                'ttndk_ten' => 'Nguyễn Cung Đàn Bên Em',
                'ttndk_gt' => 0,
                'ttndk_cmnd' => '0365214896',
                'ttndk_trangthai' => 1
            ],[
                'dkt_id' => 3,
                'ttndk_ten' => 'Trần Văn Đen Vâu',
                'ttndk_gt' => 1,
                'ttndk_cmnd' => '0369874526',
                'ttndk_trangthai' => 1
            ],[
                'dkt_id' => 3,
                'ttndk_ten' => 'Nguyễn Văn Bin Dázch',
                'ttndk_gt' => 1,
                'ttndk_cmnd' => '0369754128',
                'ttndk_trangthai' => 1
            ],[
                'dkt_id' => 4,
                'ttndk_ten' => 'Tô Li Vơ',
                'ttndk_gt' => 1,
                'ttndk_cmnd' => '0321458963',
                'ttndk_trangthai' => 1
            ],[
                'dkt_id' => 4,
                'ttndk_ten' => 'Su Bin',
                'ttndk_gt' => 0,
                'ttndk_cmnd' => '0321485632',
                'ttndk_trangthai' => 1
            ]
        ];
