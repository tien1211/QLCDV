...
class LichTrinhSeeder extends Seeder
{
    ...
    public function run()
    {
        $arr=[
            [
                'lt_ten' => 'Đảo Nam Du',
                'lt_file' => '20200724_142016-LichTrinhTGVT.docx',
            ...
            [
                'lt_ten' => 'Bình Ba',
                'lt_file' => '20200724_142040-LichTrinhTGCT.docx',
            ...
            [
                'lt_ten' => 'Bình Hưng',
                'lt_file' => '20200724_142105-LichTrinhTGDL.docx',
            ...
            [
                'lt_ten' => 'Đà Nẵng',
                'lt_file' => '20200724_142123-LichTrinhTGDN.docx',
            ...
            [
                'lt_ten' => 'Hội An',
                'lt_file' => '20200724_142139-LichTrinhTGHA.docx',
            ...
            [
                'lt_ten' => 'Sapa',
                'lt_file' => '20200724_142139-LichTrinhTGHA.docx',
                'lt_mota' => 'Sapa là một thị trấn vùng cao, là một khu nghỉ mát nổi tiếng thuộc huyện Sapa, tỉnh Lào Cai, Việt Nam. Nơi đây ẩn chứa nhiều điều kỳ diệu của tự nhiên, phong cảnh thiên nhiên với địa hình của núi đồi, màu xanh của rừng cây, tạo nên bức tranh có bố cục hài hoà, có cảnh sắc thơ mộng và hấp dẫn từ cảnh quan đất trời vùng đất phía Tây Bắc',
                'lt_trangthai' => 1
            ]
            ,
        ];
