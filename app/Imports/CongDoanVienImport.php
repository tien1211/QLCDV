...
class CongDoanVienImport implements ToCollection
{
    ...
    */
    ...
    //         '5'       =>  'required',
    //         '6'       =>  'required',
    //         '7'       =>  'required|max:9|min:9',
    //         '8'       =>  'required',
    //         '9'       =>  'required',
    //         '10'      =>  'required|max:9|min:9',
    //         '11'      =>  'required',
    //         '11'      =>  'unique:CongDoanVien'
    //         '*.12'      =>  'required',
    //         '*.13'      =>  'required',
    //         '*.14'      =>  'required',
    //         '*.15'      =>  'required',
    //         '*.16'      =>  'required',
    //         '*.17'      =>  'required|unique:CongDoanVien',
    ...
    //             '11.required'   => trans('Không được để trống email'),
    //             '11.unique'     => trans('Email đã được tồn tại vui lòng nhập lại email'),
